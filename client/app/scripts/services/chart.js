...
/**
 * @ngdoc service
 * @name visualApp.chart
 * @description
 * # chart
 * Factory in the visualApp.
 */
angular.module('visualApp')
  .factory('chart', function (ChordBox) {
      /*
    ...
    return {
        ...
        positions:positions,
        createChordStruct:createChordStruct,
        createChordElement:createChordElement,
        createSectionElement:createSectionElement,
        createShapeChart:createShapeChart
    };
  });
