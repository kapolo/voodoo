...
/**
 * @ngdoc service
 * @name visualApp.ChordBox
 * @description
 * # ChordBox
 * Factory in the visualApp.
 */
angular.module('visualApp')
  .factory('ChordBox', function () {
    /*
    ...
    var ChordBox = function(paper, x, y, width, height) {
      this.paper = paper;
      this.x = x;
      this.y = y;
    ...
    ChordBox.prototype.lightBar = function(string_from, string_to, fret_num) {
      ...
      var string_from_num = this.num_strings - string_from;
      var string_to_num = this.num_strings - string_to;
